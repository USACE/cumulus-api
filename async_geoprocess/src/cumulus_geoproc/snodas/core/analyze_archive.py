...
def snodas_get_headerfile_values(headerfile_content):
    ...
    keywords = {
        "cols": {"keyword": "Number of columns", "value": None},
        "rows": {"keyword": "Number of rows", "value": None},
        "nodata": {"keyword": "No data value", "value": None},
        "xmin": {"keyword": "Minimum x-axis coordinate", "value": None},
        "xmax": {"keyword": "Maximum x-axis coordinate", "value": None},
        "ymin": {"keyword": "Minimum y-axis coordinate", "value": None},
        "ymax": {"keyword": "Maximum y-axis coordinate", "value": None},
    }
...
if __name__ == "__main__":
    ...
    for dt, raw_infile in raw_infiles.items():
        ...
        if os.path.isfile(raw_infile):
            ...
            try:
                content = headerfile_content_from_raw_archive(
                    raw_infile, swe_headerfile_name(dt, args.infile_type)
                )
            except:
