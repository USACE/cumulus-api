-- Always re-apply product tags when running migrations: ${flyway:timestamp}
-- Primary Source product tag assignment
-- This migration creates and maintains the "Primary Source" tag for key products
