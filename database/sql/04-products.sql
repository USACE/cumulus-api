...
INSERT INTO acquirable (id, name, slug) VALUES
    ...
    ('552bf762-449f-4983-bbdc-9d89daada260', 'wrf_columbia_t2','wrf-columbia-t2'),
...
INSERT INTO product (id, name, slug, temporal_duration, temporal_resolution, dss_fpart, parameter_id, unit_id, description) VALUES
    ...
    ('b50f29f4-547b-4371-9365-60d44eef412e','wrf_columbia_precip','wrf-columbia-precip',3600,3600,'WRF-COLUMBIA-PRECIP','eb82d661-afe6-436a-b0df-2ab0b478a1af','e245d39f-3209-4e58-bfb7-4eae94b3f8dd', 'WRF Columbia precipitation data created for the entire Columbia River Basin'),
    ('793e285f-333b-41a3-b4ab-223a7a764668','wrf_columbia_t2','wrf-columbia-t2',3600,3600,'WRF-COLUMBIA-T2','5fab39b9-90ba-482a-8156-d863ad7c45ad','0c8dcd1f-93db-4e64-be1d-47b3462deb2a', 'WRF Columbia T2 (temperature at 2 m) data created for the entire Columbia River Basin'),
